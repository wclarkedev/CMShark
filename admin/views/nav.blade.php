        ...
        <div class="">
            ...
            <div id="navigation" class="hidden md:block">
                <div style="font-size: 14px; align-items: center;"
                    class="hover:text-navHoverTextColor flex text-navIconColor font-semibold bg-transparent hover:bg-navItemHover rounded w-full px-[12px] py-[10px]">
                    ...
                    <span class="text-center">Notifications</span>
                </div>
                <div style="font-size: 14px; align-items: center;"
                    class="flex text-navActiveTextColor font-semibold bg-navItemActive rounded w-full px-[12px] py-[10px]">
                    <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 12px;" width="24" height="24"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round"
                        stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <span class="text-center text-navActiveTextColor">Billing</span>
                </div>
            </div>
        </div>
    </nav>
