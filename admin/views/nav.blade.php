        ...
        <div class="">
            ...
            <div id="navigation" class="hidden md:block">
                <a href="" style="font-size: 14px; align-items: center;"
                    ...
                    <span class="text-center cursor-pointer">Notifications</span>
                </a>
                <a href="//google.com" style="font-size: 14px; align-items: center;"
                    class="cusor-pointer flex text-navActiveTextColor font-semibold bg-navItemActive rounded w-full px-[12px] py-[10px]">
                    <svg xmlns="http://www.w3.org/2000/svg" style="margin-right: 12px;" width="24" height="24"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round"
                        stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                    ...
                    <span class="text-center cursor-pointer text-navActiveTextColor">Billing</span>
                </a>
            </div>
        </div>
    </nav>
